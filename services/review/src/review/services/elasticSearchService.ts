...
import { ISellerDocument } from "@review/dto/seller.d";
import { ISellerItem } from "@review/dto/item.d";
...
export class ElasticSearchService {
  ...
  constructor() {
    ...
    this.log = winstonLogger(`${config.ELASTIC_SEARCH_URL}`, 'reviewElasticSearchServer', 'debug');
  ...
  async checkConnection(): Promise<void> {
    ...
    while (!isConnected) {
      try {
        ...
        this.log.log('error', 'reviewService checkConnection() method:', error);
      }
    }
  }

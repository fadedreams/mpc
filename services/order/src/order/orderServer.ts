...
import { KeyDBConnection } from '@order/broker/kdbConnection';
...
export class orderServer {
    ...
    private readonly keydbConnection: KeyDBConnection;
    ...
    constructor(
        ...
        this.keydbConnection = new KeyDBConnection();
    }
    ...
    // }
    private startKeyDB(): void {
        this.keydbConnection.connect();
    }
    ...
    private async startServer(app: Application): Promise<void> {
        try {
            ...
            this.log.log('error', 'orderService startServer() method error:', error);
        }
    }

...
async function consumeAuthEmailMessages(channel: Channel): Promise<void> {
  try {
    ...
    const exchangeName = 'mpc-email-alert';
    ...
    log.log('error', 'alertService EmailConsumer consumeAuthEmailMessages() method error:', error);
  }
}
...
async function consumeOrderEmailMessages(channel: Channel): Promise<void> {
  try {
    ...
    const exchangeName = 'mpc-order-alert';
    ...
    log.log('error', 'alertService EmailConsumer consumeOrderEmailMessages() method error:', error);
  }
}

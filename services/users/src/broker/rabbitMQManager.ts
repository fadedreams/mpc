...
import SellerService from '@users/users/services/sellerService';
...
export class RabbitMQManager {
  ...
  async consumeSellerDirectMessage(channel: Channel): Promise<void> {
    try {
      ...
      this.log.log('error', 'UsersService UserConsumer consumeSellerDirectMessage() method error:', error);
    }
  }
  ...
  async consumeReviewFanoutMessages(channel: Channel): Promise<void> {
    try {
      ...
      this.log.log('error', 'UsersService UserConsumer consumeReviewFanoutMessages() method error:', error);
    }
  };
}
